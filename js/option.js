	...
	chrome.management.getAll(function (apps){
		findTheGroupApps(id,function(groupApps){
			...
			for ( var i = 0; i < apps.length; i++) {
				...
				var icon = app.icons?app.icons[app.icons.length-1].url+ '?grayscale=true':"/img/default2.png";
				// icon += '?grayscale=true';
				var appHtml = '<li class="span-item"><div class="thumbnail" id="app_'+app.id+'" app-id='+app.id+'>'+
								'<img src="'+icon+'" alt="">'+
			...
			for ( var i = 0; i < groupApps.length; i++) {
				...
				icon.attr("src",normalIcon(icon.attr("src")||"/img/default2.png"));
			}
...
function normalIcon(url) {
    ...
    return a == "/img/default2.png"?"/img/default.png":a;
}
